...
| Knowledge Base / RAG | 部分实现 | PDF 解析、chunk、embedding、文本 fallback、ParserRun 审计、ParserQualityReport 指标、TextbookQualityScore 门禁、ParserReviewItem 队列、Parser Evidence 目标查询、Golden Dataset + Parser Evaluation MVP、8 题混合练习流、hint/retry/rubric 反馈；overview 返回 sources、parser/ingest 证据、quality summary、review queue、来源页码和低置信词条；Dev Console Textbook Parsing Report 展示质量指标、ParserRun 历史、Review Queue 和 Evidence Browser；前端可在多本教材之间切换；课程练习和知识点验收共用统一 ExerciseAttempt target/summary 模型 | hybrid retrieval、golden query set 扩展、练习 session 总结、更多年级 golden profile、layout-aware extractor |
