...
| 产品线 | 状态 | 说明 |
|---|---|---|
| 七年级教材线 | 部分实现 | 教材知识库、单元词汇、RAG chunk、练习题和前端入口已存在，RAG 可解释性和恢复能力正在增强 |
...
| Vocabulary Learning | 部分实现 | 单元 enroll、review/spelling、attempt、letter diff、发音 URL | 多维掌握度、薄弱原因总结、题型推荐 |
| Knowledge Base / RAG | 部分实现 | PDF 解析、chunk、embedding、文本 fallback、练习题 | hybrid retrieval、golden query set、前端证据面板 |
