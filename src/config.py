...
class Settings(BaseSettings):
    ...
    bootstrap_invite_code: str | None = None
    simulation_invite_code: str | None = None
    email_delivery_mode: str = "console"
    email_verification_secret: str = "local-email-verification-secret-change-me"
    email_verification_code_ttl_seconds: int = 600
    email_verification_token_ttl_seconds: int = 600
    ...
    smtp_from_address: str = "no-reply@binnagent.local"
