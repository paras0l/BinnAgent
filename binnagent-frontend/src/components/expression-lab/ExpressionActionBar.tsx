...
export function ExpressionActionBar({
  ...
  return (
    <footer className="shrink-0 border-t border-slate-200 bg-white/95 px-3 py-2 shadow-[0_-6px_18px_rgba(15,23,42,0.04)] backdrop-blur sm:px-5 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
      <div className="mx-auto flex max-w-[1400px] flex-col-reverse gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center justify-between gap-2 sm:justify-start">
          ...
          <Button variant="ghost" className="px-3 py-2 text-xs 2xl:hidden" onClick={onOpenEvidence}><FileText className="size-4" />来源</Button>
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <Button className="flex-1 px-3 py-2 text-xs sm:flex-none" onClick={onComplete} disabled={isCompleting || isCompleted}>
