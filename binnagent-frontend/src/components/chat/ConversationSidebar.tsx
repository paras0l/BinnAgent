    ...
    <>
      {isModal && (
        <button
          ...
          aria-label="收起历史对话"
          onClick={onToggleCollapsed}
          className="fixed inset-x-0 bottom-0 top-16 z-30 bg-slate-950/30 transition-opacity duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary motion-reduce:transition-none lg:hidden"
        />
      )}
      <aside
        ref={containerRef}
        ...
        className="fixed bottom-0 left-0 top-16 z-40 flex w-72 shrink-0 flex-col overscroll-contain border-r bg-background shadow-lg transition-[transform,opacity] duration-200 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-primary motion-reduce:transition-none lg:static lg:shadow-none"
      >
